...
public class CustomSeekbarPreference extends SeekBarPreference {
                    ...
                    if (SdkUtils.isBeforeAndroid8()) {
                        if (isShakeIntensityPreference() && progress < MIN_SHAKE_INTENSITY_VALUE) {
                            ...
                            seekBar.setProgress(MIN_BLUETOOTH_VOLUME);
                                ...
                                && progress < MIN_ANALOG_CLOCK_SIZE_VALUE) {
    ...
    /**
     * @return the current value of the SeekBar related to the screensaver analog clock size
     * from SharedPreferences.
     */
    private int getScreensaverAnalogClockSizeValue() {
    ...
    /**
     * @return the current value of the SeekBar related to timer shadow offset from SharedPreferences.
     */
    ...
    /**
     * @return the current value of the SeekBar related to the alarm analog clock size
     * from SharedPreferences.
     */
    private int getAlarmAnalogClockSizeValue() {
        return mPrefs.getInt(getKey(), DEFAULT_ANALOG_CLOCK_SIZE);
    }
